...
1. $$P ( A , B ) = P ( A \mid B ) P($$ _____)  
2. $$P ( A , B ) = P ( B \mid A ) P($$ _____)

---

### A3. Independence check from a joint table
Let $$X , Y$$ be either 0 or 1 and have the joint probability table:
...
Let $$S$$ be the Senate outcome and $$H$$ be the house outcome. They can take on either D or R as outcome values.
...
Let $$C $$ be “has cancer” and $$T $$ be “test is positive”, where $$C , T$$ take on 0 or 1.
